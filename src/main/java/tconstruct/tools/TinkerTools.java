...
public class TinkerTools
{
    ...
    private void craftingTableRecipes ()
    {
        ...
        //Curse the lack of Tool Station OreDicting, that means a for loop!
        for (int i = 10; i < 14; i++){
            GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TinkerTools.toolStationWood, 1, 15), "psp", "cbc", "w w", 'p', new ItemStack(TinkerTools.blankPattern, 1, 0), 'w', "plankWood", 's', new ItemStack(TinkerTools.toolStationWood, 1, i), 'c', "crafterWood", 'b', new ItemStack(TinkerTools.toolStationWood, 1, 1)));
            GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TinkerTools.toolStationWood, 1, 15), "psp", "cbc", "w w", 'p', new ItemStack(TinkerTools.blankPattern, 1, 0), 'w', "plankWood", 's', new ItemStack(TinkerTools.toolStationWood, 1, i), 'c', "craftingTableWood", 'b', new ItemStack(TinkerTools.toolStationWood, 1, 1)));
        }
